...
refresh_choices()
print('spk_new>>>', spk_new)


def change_choices():
    global reference_wavs
...
change_choices()
print('reference_wavs>>>', reference_wavs)
...
def main():
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            gender = gr.Radio(choices=gender_list, label='新增音色的声音性别', value=gender_list[0][1])
        ...
        with gr.Row():
            wavs_dropdown = gr.Dropdown(label="参考音频列表", choices=reference_wavs,
                                        value="请选择参考音频或者自己上传", interactive=True)
        ...
        generate_button.click(generate_audio,
                              inputs=[tts_text, mode_checkbox_group, sft_dropdown, prompt_text, prompt_wav_upload,
                                      prompt_wav_record, instruct_text,
                                      seed, stream, speed, new_dropdown, gender],
